...
//             seedTheaterSeats();
//             seedShows();       // 👈 gọi trước
//             seedBookings();    // 👈 gọi sau
//             seedPayments();    // 👈 gọi sau bookings
...
//     private void seedUsers() {
//     List<User> users = Arrays.asList(
//         createUser(1, "Hà Nội", "0912345678"),
//         createUser(2, "Hồ Chí Minh", "0987654321"),
//         createUser(3, "Đà Nẵng", "0911112222"),
//         createUser(4, "Cần Thơ", "0903334444"),
//         createUser(5, "Hải Phòng", "0935556666"),
//         createUser(6, "Huế", "0927778888"),
//         createUser(7, "Nha Trang", "0919990000"),
//         createUser(8, "Vũng Tàu", "0988889999"),
//         createUser(9, "Quảng Ninh", "0912223333"),
//         createUser(10, "Đà Lạt", "0904445555")
//     );
//     userRepository.saveAll(users);
//     System.out.println("Đã khởi tạo " + users.size() + " người dùng");
//     }

//     private User createUser(int dummyId, String address, String contact) {
//         User user = new User();
//         user.setId((long) dummyId); // Chuyển int sang Long
//         user.setAddress(address);
//         user.setContact(contact);
//         return user;
//     }
...
//             createMovie(1L, "GODZILLA VS KONG", "Legends collide as Godzilla and Kong", 2019, new BigDecimal("8.4"), "https://trailer.com/avengers", "https://poster.com/avengers.jpg", MovieType.ComingSoon),
//             createMovie(2L, "JOKER", "Arthur Fleck, a party clown, leads an impoverished life with his ailing mother. However, when society shuns him and brands him as a freak, he decides to embrace the life of crime and chaos.", 1972, new BigDecimal("9.2"), "https://trailer.com/godfather", "https://poster.com/godfather.jpg", MovieType.NowShowing),
//             createMovie(3L, "THE BATMAN", "The Riddler plays a deadly game of cat and mouse with Batman and Commissioner Gordon in Gotham City.", 2016, new BigDecimal("8.0"), "https://trailer.com/deadpool", "https://poster.com/deadpool.jpg", MovieType.Removed)
//         );
...
//             createMovieRole(movie2, role2, RoleType.Cast),
...
//             createBooking(1L, users.get(0), shows.get(0), "A", 1, 100000f, BookingStatus.Reserved, LocalDateTime.now()),
...
//             createBooking(5L, users.get(4), shows.get(4), "E", 7, 110000f, BookingStatus.Reserved, LocalDateTime.now())
//         );
...
//             createPayment(1L, 100000, LocalDateTime.now(), PaymentMethod.Card, users.get(0), shows.get(0)),
//             createPayment(2L, 120000, LocalDateTime.now().minusHours(1), PaymentMethod.Cash, users.get(1), shows.get(1)),
//             createPayment(3L, 150000, LocalDateTime.now().minusHours(2), PaymentMethod.Card, users.get(2), shows.get(2)),
//             createPayment(4L, 130000, LocalDateTime.now().minusHours(3), PaymentMethod.Card, users.get(3), shows.get(3)),
//             createPayment(5L, 110000, LocalDateTime.now().minusHours(4), PaymentMethod.Cash, users.get(4), shows.get(4)),
//             createPayment(6L, 140000, LocalDateTime.now().minusHours(5), PaymentMethod.Cod, users.get(5), shows.get(5)),
//             createPayment(7L, 160000, LocalDateTime.now().minusHours(6), PaymentMethod.Cod, users.get(6), shows.get(6)),
//             createPayment(8L, 170000, LocalDateTime.now().minusHours(7), PaymentMethod.Cash, users.get(7), shows.get(7)),
//             createPayment(9L, 180000, LocalDateTime.now().minusHours(8), PaymentMethod.Cod, users.get(8), shows.get(8)),
//             createPayment(10L, 190000, LocalDateTime.now().minusHours(9), PaymentMethod.Cash, users.get(9), shows.get(9))
//         );
...
//             createTheater(1L, "Rạp CGV Vincom", 10, 20, TheaterType.Normal),
//             createTheater(2L, "Rạp Lotte Cinema", 8, 15, TheaterType.Royal),
//             createTheater(3L, "Rạp BHD Star", 12, 18, TheaterType.Normal),
//             createTheater(4L, "Rạp Galaxy Nguyễn Trãi", 10, 22, TheaterType.Royal),
//             createTheater(5L, "Rạp Quốc Gia", 6, 10, TheaterType.Normal)
//         );
...
//             createTheaterSeat("A", 1, theaters.get(0), SeatType.Missing),
//             createTheaterSeat("A", 2, theaters.get(0), SeatType.Missing),
//             createTheaterSeat("B", 1, theaters.get(1), SeatType.Missing),
//             createTheaterSeat("B", 2, theaters.get(1), SeatType.Blocked),
//             createTheaterSeat("C", 1, theaters.get(2), SeatType.Missing),
//             createTheaterSeat("C", 2, theaters.get(2), SeatType.Missing),
//             createTheaterSeat("D", 1, theaters.get(3), SeatType.Blocked),
//             createTheaterSeat("D", 2, theaters.get(3), SeatType.Missing),
...
//         // Tạo TheaterSeatId với seatRow, seatNumber và theaterId
//         TheaterSeat.TheaterSeatId theaterSeatId = new TheaterSeat.TheaterSeatId(seatRow, seatNumber, theater.getId());
...
//             createShow(1L, LocalTime.of(10, 0), LocalTime.of(12, 30), LocalDate.of(2025, 10, 1), movies.get(0), theaters.get(0), ShowStatus.Free, ShowType.TwoD),
//             createShow(2L, LocalTime.of(13, 0), LocalTime.of(15, 30), LocalDate.of(2025, 10, 1), movies.get(1), theaters.get(1), ShowStatus.Free, ShowType.ThreeD),
//             createShow(3L, LocalTime.of(16, 0), LocalTime.of(18, 30), LocalDate.of(2025, 10, 1), movies.get(2), theaters.get(2), ShowStatus.Full, ShowType.TwoD),
//             createShow(4L, LocalTime.of(19, 0), LocalTime.of(21, 30), LocalDate.of(2025, 10, 1), movies.get(3), theaters.get(3), ShowStatus.Full, ShowType.ThreeD),
//             createShow(5L, LocalTime.of(10, 0), LocalTime.of(12, 30), LocalDate.of(2025, 10, 2), movies.get(4), theaters.get(4), ShowStatus.AlmostFull, ShowType.TwoD),
//             createShow(6L, LocalTime.of(13, 0), LocalTime.of(15, 30), LocalDate.of(2025, 10, 2), movies.get(5), theaters.get(0), ShowStatus.AlmostFull, ShowType.TwoD),
//             createShow(7L, LocalTime.of(16, 0), LocalTime.of(18, 30), LocalDate.of(2025, 10, 2), movies.get(6), theaters.get(1), ShowStatus.AlmostFull, ShowType.TwoD),
//             createShow(8L, LocalTime.of(19, 0), LocalTime.of(21, 30), LocalDate.of(2025, 10, 2), movies.get(7), theaters.get(2), ShowStatus.Free, ShowType.ThreeD),
//             createShow(9L, LocalTime.of(10, 0), LocalTime.of(12, 30), LocalDate.of(2025, 10, 3), movies.get(8), theaters.get(3), ShowStatus.Full, ShowType.TwoD),
//             createShow(10L, LocalTime.of(13, 0), LocalTime.of(15, 30), LocalDate.of(2025, 10, 3), movies.get(9), theaters.get(4), ShowStatus.Free, ShowType.ThreeD)
//         );
